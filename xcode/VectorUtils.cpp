...
namespace VectorUtils {
    ...
    vec2 VectorUtils::Subtract(vec2 v1, vec2 v2)         { return vec2(v1.x - v2.x, v1.y - v2.y);              }
    vec3 VectorUtils::Subtract(vec3 v1, vec3 v2)         { return vec3(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z); }
